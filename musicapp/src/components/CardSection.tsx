    ...
    <div className="py-12 bg-gray-900">
      <div>
        <div className="text-center">
            <h1 className="text-base text-teal-600 font-semibold text-2xl">FEATURED COURSES</h1>
                ...
                <div key={course.id} className="flex justify-center">
                    <BackgroundGradient className="flex flex-col rounded-[22px] bg-white dark:bg-zinc-900 overflow-hidden h-full max-w-sm">
                        ...
                        <div className="p-4 sm:p-3 flex  flex-col items-center text-center flex-grow">
                            <p className="text-lg sm:text-xl text-black mt-3 mb-2 dark:text-neutral-200">{course.title}</p>
