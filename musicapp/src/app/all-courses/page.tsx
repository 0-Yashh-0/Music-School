    ...
    <div className="min-h-screen bg-black py-12 pt-36">
      ...
      <div className="flex flex-wrap justify-evenly">
        {courseData.courses.map((course, index) =>(
          ...
          <CardBody className="bg-gray-50 relative group/card  dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-11/12 sm:w-[24rem] h-5/6 rounded-xl p-6 border mx-4 ">
            <CardItem
              translateZ="50"
